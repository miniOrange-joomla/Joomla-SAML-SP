...
class mo_saml_hander{
    function getResource(){
      ...
      {
        if (((int)base64_decode($appdata['userslim']) >= (int)base64_decode($customer_details['usrlmt'])) ||((int)base64_decode($appdata['sso_test'])+11 > (int)base64_decode($appdata['sso_var'])))
